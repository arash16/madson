  ...
  var preset = function (preset) {
    ...
    function packError(value) {
      ...
      for (var i = 0, key; key = ERROR_COLUMNS[i]; i++) {
        if (!isUndefined(value[key])) out[key] = value[key];
      }
    ...
    if (typeof Uint8Array !== 'undefined') {
      [[0x1A, ArrayBuffer, unpackArrayBuffer, packArrayBuffer], [0x11, Int8Array, unpackClass(Int8Array), packBuffer], [0x12, Uint8Array, unpackClass(Uint8Array)], [0x13, Int16Array, 0, packTypedArray], [0x15, Int32Array], [0x14, Uint16Array], [0x16, Uint32Array], [0x17, Float32Array], [0x1D, DataView]].forEach(function (ext, i) {
